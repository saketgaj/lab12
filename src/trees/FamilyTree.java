...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		int colonIndex =  line.indexOf(':'); //should be the index of the colon in line.
				if (colonIndex < 0)
					 throw new TreeException("improperly formatted, no children");
...
//													
													...
													else
													{
														...
														if(parentNode == null) throw new TreeException("Couldn't find parent node");
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		TreeNode node1 = root.getNodeWithName(name1);	// node whose name is name1
				if (node1 == null)
					...
					throw new TreeException("couldn't find node with name1");
							TreeNode node2 = root.getNodeWithName(name2);// node whose name is name2
									if (node2 == null)
										throw new TreeException("couldn't find node with name2");
